                            ...
                            <div class="login-form form-item form-stl">
                                ...
                                <form name="frm-login" method="POST" action="{{ route('login') }}">
                                    ...
                                    <fieldset class="wrap-input">
                                        ...
                                        <input id="frm-login-uname" type="email" name="email" :value="old('email')" required autofocus>
                                    </fieldset>
                                    <fieldset class="wrap-input">
                                        <label for="frm-login-pass">Password:</label>
                                        <input id="frm-login-pass" type="password" name="password" required autocomplete="current-password">
                                    </fieldset>
